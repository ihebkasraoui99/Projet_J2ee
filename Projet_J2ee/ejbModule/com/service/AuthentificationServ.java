...
public class AuthentificationServ {
	...
	@WebMethod
	public void addEtudiant(@WebParam String nom,@WebParam String prenom,@WebParam String email,@WebParam String password,@WebParam boolean active)
	{
		Utilisateur etd=new Etudiant( nom, prenom,email,password,active);
